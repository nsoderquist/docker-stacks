...
default  = {'saspath'  : '/usr/local/SASHome/SASFoundation/9.4/bin/sas_u8'
            ...
            #            'options' : ["-fullstimer", "-autoexec", "/home/joyvan/autoexec"]
            #            }
...
# 'appserver' - name of physical workspace server (when more than one app server defined in OMR) i.e.: 'SASApp - WorkspaceServer'
...
cpL  =  "/usr/local/SASHome/SASDeploymentManager/9.4/products/deploywiz__94130__prt__xx__sp0__1/deploywiz/sas.svc.connection.jar"
cpL += ":/usr/local/SASHome/SASDeploymentManager/9.4/products/deploywiz__94130__prt__xx__sp0__1/deploywiz/deploywiz/log4j.jar"
cpL += ":/usr/local/SASHome/SASDeploymentManager/9.4/products/deploywiz__94130__prt__xx__sp0__1/deploywiz/sas.security.sspi.jar"
cpL += ":/usr/local/SASHome/SASDeploymentManager/9.4/products/deploywiz__94130__prt__xx__sp0__1/deploywiz/sas.core.jar"
